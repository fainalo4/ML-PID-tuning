...
class SAC():
    ...
    def train(self, num_episodes):
        for episode in tqdm(range(num_episodes), desc="episodes"):
            ...
            while not done:
                ...
                self.update_params(t, [self.env.state, next_state], action, reward)
    ...
    def update_params(self, t, states, action, reward):

        hot_s= jnp.array(states[0], dtype=jnp.float32)
        hot_s1= jnp.array(states[1], dtype=jnp.float32)
...
# TODO: aggiungici advantage function A(s,a)...
